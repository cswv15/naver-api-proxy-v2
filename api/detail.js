...
const response = await fetch(
  `https://api.searchad.naver.com/keywordstool?format=json&siteId=&month=&biztpId=&event=&includeHintKeywords=0&showDetail=1&keyword=${encodeURIComponent(keyword)}`,
  {
    headers: {
      'X-API-KEY': API_KEY,
